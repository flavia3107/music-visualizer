export class VisualizerManager {
	...
	setAudioDataProvider(provider) { this.audioDataProvider = provider; }
	...
	start() { if (!this.animationFrameId) this._loop(); }
	...
	_loop = () => {
		...
		this.currentVisualizer.draw(this.ctx, data, this.bounds);
	}
}